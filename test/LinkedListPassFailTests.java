...
public class LinkedListPassFailTests {
	...
	void testInsertNode() {
		...
		assertThrows(IndexOutOfBoundsException.class, () -> linkedList.insert("f", 6));
	...
	void testReplaceNode() {
		...
		IndexOutOfBoundsException iobe = new IndexOutOfBoundsException();
		assertThrows(IndexOutOfBoundsException.class, () -> linkedList.replace("f", 5));
		System.out.println(iobe.getMessage());
	}
	...
	void testDeleteNode() {
		...
		IndexOutOfBoundsException iobe = new IndexOutOfBoundsException();
		assertThrows(IndexOutOfBoundsException.class, () -> linkedList.delete(4));
		System.out.println(iobe.getMessage());
	}
